...
seeds = 1
base_call = "python sac_script.py "
...
for s in augment_stds:
    ...
    final_call = base_call + " --logdir " + str(lpath) + " --savedir " + str(spath) + " "  + " --augment_stds " + str(s) + " --n_augments " + str(10)
    print(final_call)
    print(final_call,file=output_file)
...
for r in reward_augment_stds:
    ...
    final_call = base_call + " --logdir " + str(lpath) + " --savedir " + str(spath) + " "  + " --augment_stds " + str(0.05) + "--n_augments " + str(10) +" --reward_std " + str(r)
    print(final_call)
    print(final_call,file=output_file)
...
for s in augment_stds:
    ...
    final_call = base_call + " --logdir " + str(lpath) + " --savedir " + str(spath) + " "  + " --augment_stds " + str(s) + " --n_augments " + str(10) + " --sample_jitter True"
    print(final_call)
    print(final_call,file=output_file)
...
for r in reward_augment_stds:
    ...
    final_call = base_call + " --logdir " + str(lpath) + " --savedir " + str(spath) + " "  + " --augment_stds " + str(0.05) + "--n_augments " + str(10) +" --reward_std " + str(r) + " --sample_jitter True"
    print(final_call)
    print(final_call,file=output_file)